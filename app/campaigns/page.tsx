                            ...
                            <div className="mb-4">
                                <div className="w-full bg-gray-200 rounded-full h-2.5">
                                    <div
                                        ...
                                        style={{ width: `${(campaign.totalFunded / campaign.goalAmount) * 100}%` }}
                                    ></div>
                                </div>
                            </div>
                            <div className="flex justify-between items-center mb-4">
                                <span className="font-bold">{campaign.totalFunded.toFixed(2)} TLOS raised</span>
                                <span className="text-gray-600">{campaign.goalAmount} TLOS goal</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-gray-600">{calculateDaysLeft(campaign.deadline)} days left</span>
